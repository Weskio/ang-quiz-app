...
export class QuestionsDataService {
    private questionsData: { title: string; icon: string; questions: Question[] }[]  = [
    {
      title: 'HTML',
  ...
  extractQuestions(filterTitle: string): Question[] {
    const extractedQuestions: Question[] = [];
    for (const category of this.questionsData) {
      // Check if the category title matches the filterTitle
